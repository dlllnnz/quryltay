...
--
-- Хост: 127.0.0.1
-- Время создания: Июн 07 2024 г., 12:20
...
--
-- Структура таблицы `orgparticipants`
--

CREATE TABLE `orgparticipants` (
...
--
-- Индексы таблицы `orgparticipants`
--
ALTER TABLE `orgparticipants`
  ADD PRIMARY KEY (`op_id`),
  ADD KEY `userID` (`user_id`),
  ADD KEY `organizationID` (`organization_id`);
...
--
-- AUTO_INCREMENT для таблицы `orgparticipants`
--
ALTER TABLE `orgparticipants`
...
ALTER TABLE `messages`
  ...
  ADD CONSTRAINT `messages_ibfk_3` FOREIGN KEY (`chat_id`) REFERENCES `chats` (`chat_id`);

--
-- Ограничения внешнего ключа таблицы `orgparticipants`
--
ALTER TABLE `orgparticipants`
  ADD CONSTRAINT `orgparticipants_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`),
  ADD CONSTRAINT `orgparticipants_ibfk_2` FOREIGN KEY (`organization_id`) REFERENCES `organizations` (`organization_id`);
